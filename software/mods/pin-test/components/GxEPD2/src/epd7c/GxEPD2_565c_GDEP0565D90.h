...
#ifndef _GxEPD2_565c_GDEP0565D90_H_
#define _GxEPD2_565c_GDEP0565D90_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_565c_GDEP0565D90 : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    static const GxEPD2::Panel panel = GxEPD2::GDEP0565D90;
    ...
    static const uint16_t full_refresh_time = 12000; // ms, e.g. 11292001us
    static const uint16_t partial_refresh_time = 12000; // ms, e.g. 11292001us
    // constructor
    GxEPD2_565c_GDEP0565D90(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
    ...
    void setPaged(); // for GxEPD2_154c and GxEPD2_565c_GDEP0565D90 paged workaround
  private:
