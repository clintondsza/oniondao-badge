...
#ifndef _GxEPD2_300c_H_
#define _GxEPD2_300c_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_300c : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    static const GxEPD2::Panel panel = GxEPD2::Waveshare3inch4color;
    static const bool hasColor = true;
    static const bool hasPartialUpdate = true;
    static const bool hasFastPartialUpdate = false;
    static const uint16_t power_on_time = 600; // ms, e.g. 574001us
    static const uint16_t power_off_time = 50; // ms, e.g. 41000us
    static const uint16_t full_refresh_time = 13000; // ms, e.g. 12358001us
    static const uint16_t partial_refresh_time = 13000; // ms, e.g. 12358001us
    // constructor
    GxEPD2_300c(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
