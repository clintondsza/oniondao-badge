...
#ifndef _GxEPD2_290_GDEY029T71H_H_
#define _GxEPD2_290_GDEY029T71H_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_290_GDEY029T71H : public GxEPD2_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 168;
    static const uint16_t WIDTH_VISIBLE = WIDTH;
    static const uint16_t HEIGHT = 384;
    static const uint16_t SOURCE_SHIFT = 8; // S8..S175 connected to TFT sources
    static const GxEPD2::Panel panel = GxEPD2::GDEY029T71H;
    static const bool hasColor = false;
    static const bool hasPartialUpdate = true;
    static const bool hasFastPartialUpdate = true;
    static const bool useFastFullUpdate = true; // set false for extended (low) temperature range
    static const uint16_t power_on_time = 100; // ms, e.g. 80001us
    static const uint16_t power_off_time = 100; // ms, e.g. 80001us
    static const uint16_t full_refresh_time = 2000; // ms, e.g. 1698001us
    static const uint16_t partial_refresh_time = 400; // ms, e.g. 353001us
    // constructor
    GxEPD2_290_GDEY029T71H(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
